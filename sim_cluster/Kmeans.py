...
"""
test_post = \
    """Disk drive problems. Hi, I have prefers problem with my hard disk.After 1 year it is working only sporadically now.I tried to format it, but now it doesn'm boot any more.Any ideas? Thanks."""
